...
#                        'experiments/bathroom_dilemma_deontology/elder_care_sim_deontology.yaml', "robo_battery": 10, "time_of_day": "day"}
# )
#
# server.port = 8123
#
...
model = Home(no_patients=1, patient_starts=[patient_1_path[0][0]], robot_start=(5, 5),
                   patient_paths=[patient_1_path], patient_histories=[0], governor_conf=
                       'experiments_cmd/bedroom_dilemma_deontology/elder_care_sim_deontology.yaml', robo_battery=10, time_of_day="day", robot_character={
        })
