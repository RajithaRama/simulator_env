...
"""
Everyday Case - bedroom: Both patients preference consents to be seen. Both in living room.
No other residents.
caller = family member
character bias towards receiver, but not worker. 
"""
...
print("Telepresence dilemma bedroom PSRB everyday case finished.")