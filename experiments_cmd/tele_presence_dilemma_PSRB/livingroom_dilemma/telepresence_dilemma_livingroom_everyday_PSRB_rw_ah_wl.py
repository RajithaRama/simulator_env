...
"""
Everyday Case - livingroom: Both patients preference consents to be seen. Both in living room.
No worker.
...
print("Telepresence livingroom dilemma PSRB everyday case finished.")
