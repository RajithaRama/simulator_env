...
#                    "patient_paths": [patient_1_path], "patient_histories": [2], "governor_conf":
...
model = Home(no_patients=1, patient_starts=[patient_1_path[0][0]], robot_start=(5, 5),
             ...
             governor_conf='experiments_cmd/bedroom_dilemma_PSRB/elder_care_sim_PSRB.yaml', robo_battery=100,
