...
def run_case(dir, case_name, experiment, condition, output_name=None):
    ...
    if 'medication_dilemma_PSRB' in dir:
        shutil.copy('PSRB_medication_dilemma.log', os.path.join(data_dir, experiment, condition, output_name))
...
if __name__ == "__main__":
    ...
    run_case(dir='experiments_cmd\\medication_dilemma_PSRB', case_name='medication_dilemma_case2_PSRB_a.py',
             experiment='testing', condition='test', output_name='medication_dilemma_PSRB')